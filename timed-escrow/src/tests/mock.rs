...
use frame_support::{
	parameter_types,
	traits::{ConstU32, Contains, EqualPrivilegeOnly, GenesisBuild},
	weights::Weight,
};
use frame_system::EnsureRoot;
use primitives::nfts::{NFTData, NFTSeriesDetails};
use sp_core::H256;
use sp_runtime::{
	testing::Header,
...
impl Default for ExtBuilder {
	fn default() -> Self {
		ExtBuilder { nfts: Vec::new(), endowed_accounts: Vec::new() }
	}
}
...
pub fn new_test_ext() -> sp_io::TestExternalities {
	...
	pallet_balances::GenesisConfig::<Test> { balances: vec![(alice, 10000), (bob, 10000)] }
		.assimilate_storage(&mut t)
		.unwrap();
